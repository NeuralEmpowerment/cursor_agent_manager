...
echo "   • COMMAND_RUNNING: Command actively executing"
echo ""
echo "2. Choose option 2 to save current screen as template"
echo "3. Select the appropriate state (1=idle, 2=active, 3=run_command, 4=command_running)"
...
echo "   • assets/ui-cursor/command_running/"
echo ""
